...
func NewProvider(config Config, operatorReleaseVersion string) (*Provider, error) {
	...
	case endpoints.CnNorth1RegionID, endpoints.CnNorthwest1RegionID:
		tagConfig = aws.NewConfig().WithRegion(endpoints.CnNorthwest1RegionID)
		r53Config.Region = aws.String(endpoints.CnNorthwest1RegionID)
		r53Config.Endpoint = aws.String("https://route53.amazonaws.com.cn")
	}
